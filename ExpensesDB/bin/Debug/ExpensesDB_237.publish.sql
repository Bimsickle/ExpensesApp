...
GO
PRINT N'Rename refactoring operation with key 8a1ae569-9caa-4082-9f5c-682e4c909fdd is skipped, element [dbo].[AccountLockBalance].[TYpe] (SqlSimpleColumn) will not be renamed to CostCentre';
...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__7BE56230];


GO
PRINT N'Creating Table [dbo].[AccountLockBalance]...';
...
GO
PRINT N'Creating Table [dbo].[PeriodLock]...';
...
CREATE TABLE [dbo].[PeriodLock] (
    ...
    [Start]      DATE            NOT NULL,
    [End]        DATE            NOT NULL,
    [Asset]      DECIMAL (18, 4) NOT NULL,
    [Draw]       DECIMAL (18, 4) NOT NULL,
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[PeriodLock]...';


GO
ALTER TABLE [dbo].[PeriodLock]
    ADD DEFAULT 0 FOR [Asset];
...
GO
ALTER TABLE [dbo].[PeriodLock]
    ADD DEFAULT getdate() FOR [DateClosed];


GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[AccountLockBalance]...';


GO
ALTER TABLE [dbo].[AccountLockBalance] WITH NOCHECK
    ADD FOREIGN KEY ([LockID]) REFERENCES [dbo].[PeriodLock] ([Id]);
...
GO
ALTER TABLE [dbo].[AccountLockBalance] WITH NOCHECK
    ADD FOREIGN KEY ([Account]) REFERENCES [dbo].[CostAccount] ([Id]);
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '8a1ae569-9caa-4082-9f5c-682e4c909fdd')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('8a1ae569-9caa-4082-9f5c-682e4c909fdd')
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.AccountLockBalance'))
               AND [type] IN (N'F', N'C')
