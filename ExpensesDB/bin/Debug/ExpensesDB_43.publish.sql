...
begin
    ...
    ([Description], [CostAccountId], [ClosingDate])
    VALUES
    ('Primary Loan Account', @loan, '22/08/2023');
...
begin
    ...
    SELECT @save = Id from [dbo].[CostAccount] WHERE [Description] = 'Saving Account';
    SELECT @credit = Id from [dbo].[CostAccount] WHERE [Description] = 'Credit Account';
    SELECT @primary = Id from [dbo].[CostAccount] WHERE [Description] = 'Primary Income';--9
    SELECT @salary = Id from [dbo].[CostAccount] WHERE [Description] = 'Salary Tax Paid';--13
    SELECT @studLoan = Id from [dbo].[CostAccount] WHERE [Description] = 'Student Loan';--14
    SELECT @studPaid = Id from [dbo].[CostAccount] WHERE [Description] = 'Student Loan Paid';--15

    INSERT INTO [dbo].[Transaction] 
    ([DatePaid], [Confirmed], [Description], [DebitID], [CreditID], [Amount]) 
    VALUES 
    (N'2023-01-01', 1, N'Loan Balance', @balInit, @loan, CAST(5000.0000 AS Decimal(18, 4))),
    ...
    (N'2023-01-06', 1, N'New Credit Card', @save, @credit, CAST(25000.0000 AS Decimal(18, 4))),
    (N'2023-01-06', 1, N'Loan Payment', @loan, @save, CAST(0.0000 AS Decimal(18, 4))),
    ...
    (N'2023-01-18', 0, N'Salary', @bank, @primary, CAST(1982.5200 AS Decimal(18, 4))),
    (N'2023-01-18', 0, N'Tax', @salary, @primary, CAST(628.0000 AS Decimal(18, 4)))
end
GO
