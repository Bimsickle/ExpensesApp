...
IF EXISTS (select top 1 1 from [dbo].[BalanceDetails])
...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__6BAEFA67];
...
GO
ALTER TABLE [dbo].[BalanceDetails] DROP CONSTRAINT [FK__BalanceDe__Credi__6CA31EA0];
...
GO
ALTER TABLE [dbo].[BalanceDetails] DROP CONSTRAINT [FK__BalanceDe__Debit__6D9742D9];


GO
PRINT N'Altering Table [dbo].[BalanceDetails]...';


GO
ALTER TABLE [dbo].[BalanceDetails] ALTER COLUMN [CreditAccount] INT NOT NULL;

ALTER TABLE [dbo].[BalanceDetails] ALTER COLUMN [DebitAccount] INT NOT NULL;
