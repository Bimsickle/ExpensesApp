...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__32767D0B];
...
GO
PRINT N'Creating Procedure [dbo].[spGetLatestIncomePayment]...';
...
begin
	set nocount on;
	select 
	MAX(DatePaid) DatePaid, SUM(Amount) Amount
