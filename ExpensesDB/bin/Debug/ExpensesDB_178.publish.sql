...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__0697FACD];
...
GO
PRINT N'Altering Procedure [dbo].[spGetIncomeAccounts]...';


GO
ALTER PROCEDURE [dbo].[spGetIncomeAccounts]
	@id int
AS
begin
	set nocount on;
