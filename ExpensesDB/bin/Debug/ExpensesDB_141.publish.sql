...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__3B40CD36];
...
GO
PRINT N'Creating Procedure [dbo].[spDuplicateTransaction]...';
...
GO
PRINT N'Creating Procedure [dbo].[spGetTransaction]...';
