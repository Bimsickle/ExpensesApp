...
GO
PRINT N'Creating Procedure [dbo].[spAddWeeks]...';
...
GO
PRINT N'Creating Procedure [dbo].[spCreateRecurringExpense]...';
...
GO
PRINT N'Creating Procedure [dbo].[spGetCostAccounts]...';
...
GO
PRINT N'Creating Procedure [dbo].[spGetTransactions]...';
...
begin
    ...
    SELECT @accom = Id from [dbo].[CostAccount] WHERE [Description] = 'Accommodation';
    SELECT @studPaid = Id from [dbo].[CostAccount] WHERE [Description] = 'Education'; --32

    INSERT INTO [dbo].[Transaction] 
    ([DatePaid], [Confirmed], [Description], [DebitID], [CreditID], [Amount], [RecurranceID]) 
    VALUES 
    (DATEADD(day,8,GETDATE()), 1, N'Loan Balance', @balInit, @loant, CAST(5000.0000 AS Decimal(18, 4)), NULL),
    ...
    (DATEADD(day,-2,GETDATE()), 1, N'Rent', @accom, @bankt, CAST(1716.0000 AS Decimal(18, 4)), NULL) --get [RecurranceID]
end
