...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__3587F3E0];
...
GO
PRINT N'Altering Procedure [dbo].[spGetTransactionStatement]...';


GO
ALTER PROCEDURE [dbo].[spGetTransactionStatement]
	@startDate date,
	@endDate date,
	@account int,
	@recurr int
