...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__6ABAD62E];
...
GO
ALTER TABLE [dbo].[BalanceDetails] DROP CONSTRAINT [FK__BalanceDe__Credi__68D28DBC];
...
GO
ALTER TABLE [dbo].[BalanceDetails] DROP CONSTRAINT [FK__BalanceDe__Debit__67DE6983];
...
GO
ALTER TABLE [dbo].[BalanceDetails] ALTER COLUMN [CreditAccount] INT NULL;

ALTER TABLE [dbo].[BalanceDetails] ALTER COLUMN [DebitAccount] INT NULL;
