...
GO
PRINT N'Rename refactoring operation with key 3e6a17fb-795e-4fc5-bc51-4e9ce3cd6927 is skipped, element [dbo].[Income].[BanoAccountID] (SqlSimpleColumn) will not be renamed to BankAccountID';
...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__0C85DE4D];
...
ALTER TABLE [dbo].[Income]
    ADD [BankAccountID] INT DEFAULT 2 NOT NULL;
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '3e6a17fb-795e-4fc5-bc51-4e9ce3cd6927')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('3e6a17fb-795e-4fc5-bc51-4e9ce3cd6927')
