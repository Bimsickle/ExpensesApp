...
GO
PRINT N'The following operation was generated from a refactoring log file d8392306-6f07-4e37-8e11-7abcfed89a7d';

PRINT N'Rename [dbo].[BalanceDetails].[RecurringId] to ReccurringId';


GO
EXECUTE sp_rename @objname = N'[dbo].[BalanceDetails].[RecurringId]', @newname = N'ReccurringId', @objtype = N'COLUMN';
...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__69C6B1F5];
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd8392306-6f07-4e37-8e11-7abcfed89a7d')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d8392306-6f07-4e37-8e11-7abcfed89a7d')
