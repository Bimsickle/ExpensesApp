...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__73852659];


GO
PRINT N'Altering Table [dbo].[Income]...';


GO
ALTER TABLE [dbo].[Income]
    ADD [HoldTaxStudentLoan] INT DEFAULT 0 NULL;
...
GO
PRINT N'Refreshing Procedure [dbo].[spAddNewIncome]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spAddNewIncome]';


GO
PRINT N'Refreshing Procedure [dbo].[spDeleteIncomeAccount]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spDeleteIncomeAccount]';


GO
PRINT N'Refreshing Procedure [dbo].[spGetCostAccounts]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spGetCostAccounts]';


GO
PRINT N'Refreshing Procedure [dbo].[spUpdateIncome]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spUpdateIncome]';
