...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__19DFD96B];
...
GO
PRINT N'Altering Procedure [dbo].[spCreateDebitAccount]...';


GO
ALTER PROCEDURE [dbo].[spCreateDebitAccount]
	@desc varchar(50),
	@bank varchar(50),
	@openDate date,
	@rate decimal(18,4),
...
GO
PRINT N'Creating Procedure [dbo].[spGetDebitAccount]...';
