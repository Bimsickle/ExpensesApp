...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__151B244E];
...
GO
PRINT N'Creating Procedure [dbo].[spSetOpeningBalanceAccount]...';
...
begin
	...
	DECLARE @credit int = (Select case when @cost <> 1 then @account else @balanceAccount end)
