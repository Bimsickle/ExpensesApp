...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__607251E5];
...
GO
PRINT N'Creating Procedure [dbo].[spAddNewIncome]...';
...
begin
	...
	([Description] , [CostAccountID], [StartDate], [EndDate], [Active], [SalaryRate], [SalaryTaxID], [TaxHeld], [SalaryCycleID], 
	[StandardWeekHours], [PayCycle], [PayCycleInrem], [PayStartDate], [PayDayOfWeek], [WeekendRate], [HolidayRate], [EveningRate], 
	[PaidLeaveHoursAnnual], [BankAccountID] )
	VALUES
	(@description, @costAccountID, @start, @end , @active, @salaryrate,@taxCalcRate, @taxheld, @salaryCycleID ,
	@weekhours ,@payCycle , @payCycleIncrem , @payStart , @paydayWeekday ,@weekendrate ,@holidayrate ,@eveningrate ,
	@paidAnnualLeaveHours, @BankAccountID );
	
	SELECT @@IDENTITY;
	
end
GO
PRINT N'Creating Procedure [dbo].[spDeleteIncomeAccount]...';
...
GO
PRINT N'Creating Procedure [dbo].[spUpdateIncome]...';
