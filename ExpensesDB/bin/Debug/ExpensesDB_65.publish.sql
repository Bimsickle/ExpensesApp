...
GO
PRINT N'Creating Table [dbo].[WeekDates]...';
...
GO
ALTER TABLE [dbo].[CreditAccount]
    ADD DEFAULT GETDATE() FOR [OpeningDate];
...
GO
ALTER TABLE [dbo].[RecurringExpenses]
    ADD DEFAULT GETDATE() FOR [DateStart];
...
ALTER TABLE [dbo].[Transaction]
    ADD DEFAULT GETDATE() FOR [DatePaid];
...
GO
ALTER TABLE [dbo].[Transaction]
    ADD FOREIGN KEY ([RecurranceID]) REFERENCES [dbo].[RecurringExpenses] ([Id]);
...
GO
PRINT N'Creating Procedure [dbo].[AddWeeks]...';


GO
CREATE PROCEDURE [dbo].[AddWeeks]
	@StartDate date
AS
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '4d3c6ac3-f84d-43aa-b251-d6f403d689e3')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('4d3c6ac3-f84d-43aa-b251-d6f403d689e3')
...
begin
    ...
    VALUES 
    (DATEADD(day,8,GETDATE()), 1, N'Loan Balance', @balInit, @loant, CAST(5000.0000 AS Decimal(18, 4))),
    (DATEADD(day,8,GETDATE()), 1, N'New Units', @studPaid, @studLoan, CAST(2004.0000 AS Decimal(18, 4))),
    (DATEADD(day,8,GETDATE()), 1, N'Maths', @studPaid, @studLoan, CAST(494.2200 AS Decimal(18, 4))),
    (GETDATE(), 1, N'Help Paid with Tax', @balInit, @salTax, CAST(10000.0000 AS Decimal(18, 4))),
    (GETDATE(), 1, N'Help', @studLoan, @balInit, CAST(10000.0000 AS Decimal(18, 4))),
    (DATEADD(day,2,GETDATE()), 1, N'New Credit Card', @bankt, @creditt, CAST(6000.0000 AS Decimal(18, 4))),
    (DATEADD(day,2,GETDATE()), 1, N'New Credit Card', @creditt, @bankt, CAST(116.7800 AS Decimal(18, 4))),
    (DATEADD(day,2,GETDATE()), 1, N'notes', @loan, @balInit, CAST(2360.8100 AS Decimal(18, 4))),
    (DATEADD(day,1,GETDATE()), 1, N'Help Balance', @balInit, @studLoan, CAST(18000.0000 AS Decimal(18, 4))),
    (DATEADD(day,12,GETDATE()), 0, N'Salary', @bankt, @primaryt, CAST(1982.5200 AS Decimal(18, 4))),
    (DATEADD(day,12,GETDATE()), 0, N'Tax', @salaryt, @primaryt, CAST(628.0000 AS Decimal(18, 4)))
end
