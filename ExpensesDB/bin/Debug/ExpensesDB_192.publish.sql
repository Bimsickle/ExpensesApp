...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__3B0BC30C];
...
begin
	...
	i.StandardWeekHours, i.PayCycle, i.SalaryTaxID, i.HoldTaxStudentLoan, i.PayCycleInrem
	FROM [dbo].[Income] i 
