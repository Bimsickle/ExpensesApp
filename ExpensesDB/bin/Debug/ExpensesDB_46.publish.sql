...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__60A75C0F];
...
begin
    ...
    SELECT @savet = Id from [dbo].[CostAccount] WHERE [Description] = 'Saving Account';
    SELECT @creditt = Id from [dbo].[CostAccount] WHERE [Description] = 'Credit Account';
    SELECT @primaryt = Id from [dbo].[CostAccount] WHERE [Description] = 'Primary Income';--9
    SELECT @salaryt = Id from [dbo].[CostAccount] WHERE [Description] = 'Salary Tax Paid';--13
    ...
    (N'2023-01-06', 1, N'New Credit Card', @savet, @creditt, CAST(25000.0000 AS Decimal(18, 4))),
    (N'2023-01-06', 1, N'Loan Payment', @loant, @savet, CAST(0.0000 AS Decimal(18, 4))),
