...
IF EXISTS (select top 1 1 from [dbo].[BalanceGroups])
...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__6501FCD8];


GO
PRINT N'Altering Table [dbo].[BalanceGroups]...';


GO
ALTER TABLE [dbo].[BalanceGroups] ALTER COLUMN [Description] VARCHAR (50) NOT NULL;
