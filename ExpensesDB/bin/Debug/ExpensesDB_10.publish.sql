/*
Deployment script for ExpenseDB
...
GO
:setvar DatabaseName "ExpenseDB"
:setvar DefaultFilePrefix "ExpenseDB"
...
begin
    ...
    SELECT @tax = a.Id FROM(SELECT Id Id, Min(Annual) Annual from dbo.[TaxRate] WHERE Annual >= @salary)a;
    SELECT @tax0 = a.Id FROM(SELECT Id Id, Min(Annual) Annual from dbo.[TaxRate])a;
