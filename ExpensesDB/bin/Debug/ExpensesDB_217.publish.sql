...
GO
PRINT N'Rename refactoring operation with key cdb2ed19-1c8a-4c2c-a0a8-c42a73ceb6dd, 4a21420f-868f-444c-99ea-c23cffbf6cc1 is skipped, element [dbo].[BalanceDetails].[BalanceID] (SqlSimpleColumn) will not be renamed to BalanceGroupId';
...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__55BFB948];


GO
PRINT N'Creating Table [dbo].[BalanceDetails]...';
...
GO
PRINT N'Creating Table [dbo].[BalanceGroups]...';
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[BalanceDetails]...';


GO
ALTER TABLE [dbo].[BalanceDetails]
    ADD DEFAULT 1 FOR [Status];


GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[BalanceGroups]...';


GO
ALTER TABLE [dbo].[BalanceGroups]
...
GO
PRINT N'Altering Procedure [dbo].[spGetTransactions]...';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'cdb2ed19-1c8a-4c2c-a0a8-c42a73ceb6dd')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('cdb2ed19-1c8a-4c2c-a0a8-c42a73ceb6dd')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '4a21420f-868f-444c-99ea-c23cffbf6cc1')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('4a21420f-868f-444c-99ea-c23cffbf6cc1')
