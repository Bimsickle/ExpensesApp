...
GO
PRINT N'The following operation was generated from a refactoring log file 695223e4-df3e-4fd0-a89e-758d566a659c';

PRINT N'Rename [dbo].[PeriodLock].[Start] to StartDate';


GO
EXECUTE sp_rename @objname = N'[dbo].[PeriodLock].[Start]', @newname = N'StartDate', @objtype = N'COLUMN';


GO
PRINT N'The following operation was generated from a refactoring log file c08f743e-5cad-45ff-90d9-0d3f1fe98bf8';

PRINT N'Rename [dbo].[PeriodLock].[End] to EndDate';


GO
EXECUTE sp_rename @objname = N'[dbo].[PeriodLock].[End]', @newname = N'EndDate', @objtype = N'COLUMN';


GO
PRINT N'The following operation was generated from a refactoring log file d153d34a-362f-428f-9fb0-d8f04f75a486';

PRINT N'Rename [dbo].[AccountLockBalance].[Date] to DateBalanced';


GO
EXECUTE sp_rename @objname = N'[dbo].[AccountLockBalance].[Date]', @newname = N'DateBalanced', @objtype = N'COLUMN';
...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__0FEC5ADD];
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '695223e4-df3e-4fd0-a89e-758d566a659c')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('695223e4-df3e-4fd0-a89e-758d566a659c')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c08f743e-5cad-45ff-90d9-0d3f1fe98bf8')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c08f743e-5cad-45ff-90d9-0d3f1fe98bf8')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd153d34a-362f-428f-9fb0-d8f04f75a486')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d153d34a-362f-428f-9fb0-d8f04f75a486')
