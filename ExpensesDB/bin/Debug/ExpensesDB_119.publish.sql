...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__236943A5];
...
GO
PRINT N'Creating Procedure [dbo].[spAddReccurringExpense]...';
...
begin
	...
	VALUES
	(@description, @start, @end, @costAccountID, @bankAccount, 
	@frequencyID, @increm, 
	@amount, 
...
GO
PRINT N'Creating Procedure [dbo].[spUpdateRecurring]...';
