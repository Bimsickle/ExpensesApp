...
GO
PRINT N'Rename refactoring operation with key 71a37642-703c-4198-a1c2-82a14dea0009 is skipped, element [dbo].[LeaveAccount].[AcrrualType] (SqlSimpleColumn) will not be renamed to AccrualType';


GO
PRINT N'Rename refactoring operation with key b95338c8-a67e-49f1-ba59-a3f99f834907 is skipped, element [dbo].[LeaveTransaction].[Hours] (SqlSimpleColumn) will not be renamed to HoursDebit';
...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__09746778];


GO
PRINT N'Creating Table [dbo].[LeaveAccount]...';
...
CREATE TABLE [dbo].[LeaveAccount] (
    ...
    [PayableOnExit] INT             NOT NULL,
    [TotalEarned]   DECIMAL (18, 4) NOT NULL,
    [TotalType]     INT             NOT NULL,
    [AccrualPeriod] DECIMAL (18, 4) NOT NULL,
    [AccrualType]   INT             NOT NULL,
    [HourRate]      DECIMAL (18, 4) NOT NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
PRINT N'Creating Table [dbo].[LeaveTransaction]...';
...
CREATE TABLE [dbo].[LeaveTransaction] (
    ...
    [Date]        DATE            NOT NULL,
    [HoursDebit]  DECIMAL (18, 4) NOT NULL,
    [HoursCredit] DECIMAL (18, 4) NOT NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[LeaveAccount]...';


GO
ALTER TABLE [dbo].[LeaveAccount]
...
GO
ALTER TABLE [dbo].[LeaveAccount]
    ADD DEFAULT 1 FOR [PayableOnExit];
...
GO
ALTER TABLE [dbo].[LeaveAccount]
    ADD DEFAULT 1 FOR [AccrualPeriod];
...
GO
ALTER TABLE [dbo].[LeaveAccount]
    ADD DEFAULT 0 FOR [HourRate];


GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[LeaveTransaction]...';


GO
ALTER TABLE [dbo].[LeaveTransaction]
    ADD DEFAULT 1 FOR [LeaveId];
...
GO
ALTER TABLE [dbo].[LeaveTransaction]
    ADD DEFAULT 0 FOR [HoursCredit];


GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[LeaveAccount]...';


GO
ALTER TABLE [dbo].[LeaveAccount] WITH NOCHECK
    ADD FOREIGN KEY ([IncomeId]) REFERENCES [dbo].[Income] ([Id]);
...
GO
ALTER TABLE [dbo].[LeaveAccount] WITH NOCHECK
    ADD FOREIGN KEY ([TotalType]) REFERENCES [dbo].[Frequency] ([Id]);
...
GO
ALTER TABLE [dbo].[LeaveAccount] WITH NOCHECK
    ADD FOREIGN KEY ([AccrualType]) REFERENCES [dbo].[Frequency] ([Id]);


GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[LeaveTransaction]...';


GO
ALTER TABLE [dbo].[LeaveTransaction] WITH NOCHECK
    ADD FOREIGN KEY ([LeaveId]) REFERENCES [dbo].[LeaveAccount] ([Id]);


GO
-- Refactoring step to update target server with deployed transaction logs
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '71a37642-703c-4198-a1c2-82a14dea0009')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('71a37642-703c-4198-a1c2-82a14dea0009')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b95338c8-a67e-49f1-ba59-a3f99f834907')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b95338c8-a67e-49f1-ba59-a3f99f834907')
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.LeaveAccount'), OBJECT_ID(N'dbo.LeaveTransaction'))
               AND [type] IN (N'F', N'C')
