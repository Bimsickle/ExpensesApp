...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__04E4BC85];
...
GO
PRINT N'Creating Procedure [dbo].[spGetBankAccountBalances]...';
...
begin
	set nocount on;
	select da.Id, da.CostAccountID, da.Description AccountName, da.Bank, isnull(credits.deposits,0) - isnull(debits.withdrawals,0) Balance 
