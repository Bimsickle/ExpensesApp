...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__3BFFE745];
...
begin
	...
	i.StandardWeekHours, i.PayCycle, i.SalaryTaxID, i.HoldTaxStudentLoan, i.PayCycleInrem, i.PayDayOfWeek
	FROM [dbo].[Income] i 
