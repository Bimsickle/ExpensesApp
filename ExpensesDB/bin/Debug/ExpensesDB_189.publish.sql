...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__382F5661];
...
GO
PRINT N'Altering Procedure [dbo].[spGetLatestIncomePayment]...';


GO
ALTER PROCEDURE [dbo].[spGetLatestIncomePayment]
	@id int
AS
begin
	set nocount on;
