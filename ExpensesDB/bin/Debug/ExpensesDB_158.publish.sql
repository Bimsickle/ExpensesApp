...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__76619304];
...
GO
PRINT N'Altering Procedure [dbo].[spAddNewIncome]...';


GO
ALTER PROCEDURE [dbo].[spAddNewIncome]
...
GO
PRINT N'Altering Procedure [dbo].[spUpdateIncome]...';


GO
ALTER PROCEDURE [dbo].[spUpdateIncome]
	@id int,
	@description varchar(50),
	@costAccountID int,
	@start Date,
