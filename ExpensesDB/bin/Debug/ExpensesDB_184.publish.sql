...
GO
PRINT N'Rename refactoring operation with key 6d2e07fb-3182-4e25-af2c-abe18e0b7eb4 is skipped, element [dbo].[Superannuation].[DebitAccount] (SqlSimpleColumn) will not be renamed to ExpenseAccount';
...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__2F9A1060];


GO
PRINT N'Creating Table [dbo].[Superannuation]...';
...
CREATE TABLE [dbo].[Superannuation] (
    ...
    [SuperAccount]    INT          NOT NULL,
    [IncomeAccount]   INT          NOT NULL,
    [InterestAccount] INT          NOT NULL,
...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Superannuation]...';


GO
ALTER TABLE [dbo].[Superannuation]
    ADD DEFAULT 1 FOR [AccountStatus];


GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[Superannuation]...';


GO
ALTER TABLE [dbo].[Superannuation] WITH NOCHECK
    ADD FOREIGN KEY ([SuperAccount]) REFERENCES [dbo].[CostAccount] ([Id]);
...
GO
ALTER TABLE [dbo].[Superannuation] WITH NOCHECK
    ADD FOREIGN KEY ([IncomeAccount]) REFERENCES [dbo].[CostAccount] ([Id]);
...
GO
ALTER TABLE [dbo].[Superannuation] WITH NOCHECK
    ADD FOREIGN KEY ([InterestAccount]) REFERENCES [dbo].[CostAccount] ([Id]);
...
GO
ALTER TABLE [dbo].[Superannuation] WITH NOCHECK
    ADD FOREIGN KEY ([ExpenseAccount]) REFERENCES [dbo].[CostAccount] ([Id]);


GO
-- Refactoring step to update target server with deployed transaction logs
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '6d2e07fb-3182-4e25-af2c-abe18e0b7eb4')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('6d2e07fb-3182-4e25-af2c-abe18e0b7eb4')
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.Superannuation'))
               AND [type] IN (N'F', N'C')
