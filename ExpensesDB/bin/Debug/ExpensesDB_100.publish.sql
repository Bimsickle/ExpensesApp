...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__17F790F9];
...
GO
PRINT N'Altering Procedure [dbo].[spSetOpeningBalanceAccount]...';


GO
ALTER PROCEDURE [dbo].[spSetOpeningBalanceAccount]
		@account int,
		@amount decimal(18,4),
		@date date
