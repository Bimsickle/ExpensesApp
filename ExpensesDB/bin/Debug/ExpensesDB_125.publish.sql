...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__2B0A656D];


GO
PRINT N'Creating Table [dbo].[IncreaseType]...';
...
GO
PRINT N'Creating Procedure [dbo].[spGetIncreaseType]...';
