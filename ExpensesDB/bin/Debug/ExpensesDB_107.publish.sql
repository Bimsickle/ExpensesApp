...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__1CBC4616];
...
begin
	...
	select 
		...
		'Credit' Account, 
		Limit, 
		Limit -((isnull(c.amount,0) * ct.CreditDebit) - (isnull(d.amount,0) * ct.CreditDebit))  Balance
	...
	order by Balance Desc, AccountName asc
