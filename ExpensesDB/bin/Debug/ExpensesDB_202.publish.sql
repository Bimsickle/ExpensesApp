...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__41B8C09B];
...
GO
PRINT N'Altering Procedure [dbo].[spRecordTransaction]...';


GO
ALTER PROCEDURE [dbo].[spRecordTransaction]
		@debit int,
        @credit int,
        @amount decimal(18,4),
        @date date,
