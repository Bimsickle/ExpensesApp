...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__3A4CA8FD];
...
GO
PRINT N'Creating Procedure [dbo].[spGetCostAccountById]...';
...
begin
	...
	SELECT 
	[Id], [Description], [CostCentre], [Edit], [Active] 
