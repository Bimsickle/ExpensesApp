...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__625A9A57];


GO
PRINT N'Altering Table [dbo].[LoanAccount]...';


GO
ALTER TABLE [dbo].[LoanAccount]
    ADD [EducationTaxLoan] INT DEFAULT 0 NULL;
...
GO
PRINT N'Refreshing Procedure [dbo].[spGetBankAccountBalances]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spGetBankAccountBalances]';
