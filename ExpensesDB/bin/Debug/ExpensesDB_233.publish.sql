...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__6E8B6712];
...
GO
PRINT N'Creating Procedure [dbo].[spGetBalanceDetails]...';
...
GO
PRINT N'Creating Procedure [dbo].[spGetBalanceGroups]...';
