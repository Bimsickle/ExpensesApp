...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__0E6E26BF];
...
GO
PRINT N'Creating Procedure [dbo].[CreateDebitAccount]...';


GO
CREATE PROCEDURE [dbo].[CreateDebitAccount]
	@desc varchar(50),
	@bank varchar(50),
	@openDate date,
	@rate decimal(18,4),
