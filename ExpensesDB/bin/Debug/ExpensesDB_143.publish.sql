...
GO
ALTER TABLE [dbo].[TaxRate] DROP CONSTRAINT [DF__TaxRate__Medicar__3D2915A8];
...
GO
PRINT N'Altering Procedure [dbo].[spDuplicateTransaction]...';


GO
ALTER PROCEDURE [dbo].[spDuplicateTransaction]
	@id int
