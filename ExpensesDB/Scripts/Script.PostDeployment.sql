...
begin
    ...
    ('Initial Balances', (SELECT Id FROM dbo.[CostTable] WHERE Account = 'Equity'), 0), 
...
begin
    ...
    DECLARE @primary int;
    DECLARE @other int;
    DECLARE @salary decimal = 80000.00;
    DECLARE @tax int;
    DECLARE @salary0 decimal = 50.00;
    DECLARE @tax0 int;
    ...
    ('Cash Income',@other, NULL, @salary0, @tax0, @week,@quarter);    
end
...
begin
    ...
    VALUES ( N'Rent - Real Estate', 1, DATEADD(day,-2,GETDATE()), NULL, @accom, @bankt, @monthly, 1, CAST(2000.0000 AS Decimal(18, 4)))
end
...
begin
    ...
    SELECT @reccur = Id from [dbo].[RecurringExpenses]  WHERE [Description] = 'Rent - Real Estate';
    ...
    (DATEADD(day,8,GETDATE()), 1, N'New Units', @studPaid, @studLoan, CAST(2000.0000 AS Decimal(18, 4)), NULL),
    (DATEADD(day,8,GETDATE()), 1, N'Maths', @studPaid, @studLoan, CAST(400 AS Decimal(18, 4)), NULL),
    (DATEADD(day,2,GETDATE()), 1, N'New Credit Card', @balInit, @creditt, CAST(6000.0000 AS Decimal(18, 4)), NULL),
    (DATEADD(day,2,GETDATE()), 1, N'New Credit Card', @creditt, @bankt, CAST(2000 AS Decimal(18, 4)), NULL),
    (DATEADD(day,2,GETDATE()), 1, N'Test Transaction', @loan, @balInit, CAST(2500 AS Decimal(18, 4)), NULL),
    (DATEADD(day,12,GETDATE()), 0, N'Salary', @bankt, @primaryt, CAST(1000 AS Decimal(18, 4)), NULL),
    (DATEADD(day,12,GETDATE()), 0, N'Tax', @taxHold, @salTax, CAST(500.0000 AS Decimal(18, 4)), NULL),
    (DATEADD(day,12,GETDATE()), 0, N'Tax Paid on Salary', @salaryt, @taxHold, CAST(500 AS Decimal(18, 4)), NULL),
    (DATEADD(day,12,GETDATE()), 0, N'Salaray Paid on Hellp', @studLoan, @taxHold, CAST(100 AS Decimal(18, 4)), NULL),
    (DATEADD(day,-3,GETDATE()), 0, N'Salary', @bankt, @primaryt, CAST(1500 AS Decimal(18, 4)), NULL),
    (DATEADD(day,-3,GETDATE()), 0, N'Tax', @taxHold, @salTax, CAST(500.0000 AS Decimal(18, 4)), NULL),
    (DATEADD(day,-3,GETDATE()), 0, N'Tax Paid on Salary', @salaryt, @taxHold, CAST(500 AS Decimal(18, 4)), NULL),
    (DATEADD(day,-3,GETDATE()), 0, N'Salaray Paid on Hellp', @studLoan, @taxHold, CAST(100 AS Decimal(18, 4)), NULL),
    ...
    (DATEADD(day,1,GETDATE()), 1, N'Paid an expenses', @rego, @creditt, CAST(50 AS Decimal(18, 4)), NULL),
    (DATEADD(day,-2,GETDATE()), 1, N'Rent', @accom, @bankt, CAST(2000.0000 AS Decimal(18, 4)), @reccur) 
end
